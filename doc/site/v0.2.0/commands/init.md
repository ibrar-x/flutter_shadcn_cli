...
- `init <namespace>` executes inline init actions from registry directory data.
- Namespace init does not require `meta.json` bootstrap files.
- If a namespace has no init actions, command succeeds with a friendly message.
